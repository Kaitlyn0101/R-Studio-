...
names(Fielding)
```
All three data frames have playerID, yearID, teamID, lgID, G, and stint. Batting and pitching share HBP, SF, and H. Batting and fielding both share CS. Pitching and fielding share GS. The primary key for all data frames is PlayerID.
